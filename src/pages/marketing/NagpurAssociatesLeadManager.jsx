...
const NagpurAssociatesLeadManager = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const queueRes = await fetch(`${API_BASE_URL}/api/naleads/nagpurassociates/all-leads`, { method: 'GET', headers });
        // 2. Fetch Calendar Details
        const calendarRes = await fetch(`${API_BASE_URL}/api/naleads/nagpurassociates/visit-details`, { method: 'GET', headers });
  ...
  const handleCompleteAction = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/naleads/assign`, {
...
export default NagpurAssociatesLeadManager;