...
export default function FieldMyTeam() {
  ...
  async function fetchTeam() {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/api/cleads/corporatemarketing/all-leads`,
        {
      ...
      const employees =
        json.employees || json.fieldEmployees || json.data?.employees || [];
  ...
  async function apiAssignLead(leadId, empId) {
    const token = getToken();
    const res = await fetch(`${API_BASE_URL}/api/cleads/assign`, {
      method: "PATCH",
      headers: {
