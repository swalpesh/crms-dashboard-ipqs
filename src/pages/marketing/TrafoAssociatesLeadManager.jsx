...
const TrafoAssociatesLeadManager = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const queueRes = await fetch(`${API_BASE_URL}/api/taleads/trafoassociates/all-leads`, { method: 'GET', headers });
        // 2. Fetch Calendar Details
        const calendarRes = await fetch(`${API_BASE_URL}/api/taleads/trafoassociates/visit-details`, { method: 'GET', headers });
  ...
  const handleCompleteAction = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/taleads/assign`, {
...
export default TrafoAssociatesLeadManager;