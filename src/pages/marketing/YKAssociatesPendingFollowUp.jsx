...
const YKAssociatesPendingFollowup = () => {
  ...
  const fetchFollowUps = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/ykaleads/my-leads?lead_status=follow-up`, {
        method: 'GET',
  ...
  const handleApprove = async (lead) => {
    ...
    try {
      ...
      const changeStagePromise = fetch(`${API_BASE_URL}/api/ykaleads/change-stage`, {
        method: 'PATCH',
        headers: { 
      ...
      const poStatusPromise = fetch(`${API_BASE_URL}/api/ykaleads/po-status`, {
        method: 'PUT',
        headers: { 
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json' 
  ...
  const handleSubmitReschedule = async () => {
    ...
    try {
      const token = getToken();
      const response = await fetch(`${API_BASE_URL}/api/ykaleads/${activeLead.lead_id}/status`, {
        method: 'PATCH',
        headers: { 
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json' 
...
export default YKAssociatesPendingFollowup;