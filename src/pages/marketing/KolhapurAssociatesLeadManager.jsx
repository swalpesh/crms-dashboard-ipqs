...
const KolhapurAssociatesLeadManager = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const queueRes = await fetch(`${API_BASE_URL}/api/kaleads/kolhapurassociates/all-leads`, { method: 'GET', headers });
        // 2. Fetch Calendar Details
        const calendarRes = await fetch(`${API_BASE_URL}/api/kaleads/kolhapurassociates/visit-details`, { method: 'GET', headers });
  ...
  const handleCompleteAction = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        kolhapur_associate_visit_date: visitDate,
        kolhapur_associate_visit_time: formattedTime,
        kolhapur_associate_visit_priority: priority,
      ...
      const response = await fetch(`${API_BASE_URL}/api/kaleads/assign`, {
...
export default KolhapurAssociatesLeadManager;