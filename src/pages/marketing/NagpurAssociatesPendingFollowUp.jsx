...
const NagpurAssociatesPendingFollowup = () => {
  ...
  const fetchFollowUps = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/naleads/my-leads?lead_status=follow-up`, {
        method: 'GET',
  ...
  const handleApprove = async (lead) => {
    ...
    try {
      ...
      const changeStagePromise = fetch(`${API_BASE_URL}/api/naleads/change-stage`, {
        method: 'PATCH',
        headers: { 
  ...
  const handleSubmitReschedule = async () => {
    ...
    try {
      const token = getToken();
      const response = await fetch(`${API_BASE_URL}/api/naleads/${activeLead.lead_id}/status`, {
        method: 'PATCH',
        headers: { 
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json' 
...
export default NagpurAssociatesPendingFollowup;